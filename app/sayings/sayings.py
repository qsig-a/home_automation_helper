...
def _get_db_connection(settings: Settings) -> Union[mysql.connector.MySQLConnection, None]:
    """
...
def _get_random_quote_from_db(table_name: str, settings: Settings) -> Union[str, None]:
    """
...
def GetSingleRandSfwS(settings: Settings) -> Union[str, None]:
    """
...
def GetSingleRandNsfwS(settings: Settings) -> Union[str, None]:
    """
